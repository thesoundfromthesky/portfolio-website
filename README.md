...
- [X] Study the code base and identify both responsive units and where media queries were used.  Take notes on anything that confuses you or interesting things you find.  Share this information in your standup meeting with your group
	...
	Overview
		...
		1. I tried to look through project in order of .html .css .scss.

	A. .html

		1. I tried to see how classes were named and how commenting was done. It seemed like to me that words that were used for naming and commenting were simple and straight forward.
		2. I checked dependencies and googled to see the purpose.
		3. Format on document was well done.

	B. .css

		1. A lot of scss part files are compiled to one css file, so I decided to go through css code in scss.

	C. .scss

		1. Folder structure was well organized. rem unit was not used, but different sizes of px were used for each breakpoints.

	d. what interested you?

		1. Perspective lines on the background and parallax effect were interesting.
		2. I looked into code to see how it's done.

	e. what confused you?

		1. I was confused at first, but I did my best to understand the code.
